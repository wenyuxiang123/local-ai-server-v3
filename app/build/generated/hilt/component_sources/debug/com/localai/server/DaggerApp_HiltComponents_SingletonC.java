...
import com.localai.server.di.DatabaseModule;
import com.localai.server.di.DatabaseModule_ProvideChatDatabaseFactory;
import com.localai.server.di.DatabaseModule_ProvideConversationDaoFactory;
import com.localai.server.di.DatabaseModule_ProvideMessageDaoFactory;
import com.localai.server.di.EngineModule;
import com.localai.server.di.EngineModule_ProvideLlamaEngineFactory;
import com.localai.server.di.RepositoryModule;
import com.localai.server.di.RepositoryModule_ProvideAIRepositoryFactory;
...
import com.localai.server.service.AIService_MembersInjector;
import com.localai.server.ui.chat.ChatActivity;
import com.localai.server.ui.chat.ChatViewModel;
import com.localai.server.ui.chat.ChatViewModel_HiltModules_KeyModule_ProvideFactory;
import com.localai.server.ui.main.MainViewModel;
import com.localai.server.ui.main.MainViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(2).add(ChatViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(MainViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(2).put("com.localai.server.ui.chat.ChatViewModel", ((Provider) chatViewModelProvider)).put("com.localai.server.ui.main.MainViewModel", ((Provider) mainViewModelProvider)).build();
    }
  ...
  private static final class ServiceCImpl extends App_HiltComponents.ServiceC {
    ...
    @Override
    public void injectAIService(AIService aIService) {
      injectAIService2(aIService);
    }

    @CanIgnoreReturnValue
    private AIService injectAIService2(AIService instance) {
      AIService_MembersInjector.injectEngine(instance, singletonCImpl.provideLlamaEngineProvider.get());
      return instance;
    }
  }
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideChatDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<ChatDatabase>(singletonCImpl, 2));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.localai.server.data.repository.ChatRepositoryImpl 
          return (T) new ChatRepositoryImpl(singletonCImpl.provideConversationDaoProvider.get(), singletonCImpl.provideMessageDaoProvider.get());

          case 1: // com.localai.server.data.local.dao.ConversationDao 
          return (T) DatabaseModule_ProvideConversationDaoFactory.provideConversationDao(singletonCImpl.provideChatDatabaseProvider.get());

          case 2: // com.localai.server.data.local.ChatDatabase 
          return (T) DatabaseModule_ProvideChatDatabaseFactory.provideChatDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
