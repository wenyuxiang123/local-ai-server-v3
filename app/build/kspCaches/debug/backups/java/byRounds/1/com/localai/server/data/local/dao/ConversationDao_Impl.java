...
public final class ConversationDao_Impl implements ConversationDao {
  ...
  public ConversationDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfConversation = new EntityInsertionAdapter<Conversation>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `conversations` (`id`,`title`,`createdAt`,`updatedAt`) VALUES (nullif(?, 0),?,?,?)";
      }
      ...
      public List<Conversation> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Conversation(_tmpId,_tmpTitle,_tmpCreatedAt,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Conversation call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpUpdatedAt;
            _tmpUpdatedAt = _cursor.getLong(_cursorIndexOfUpdatedAt);
            _result = new Conversation(_tmpId,_tmpTitle,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Flow<Conversation> getConversationByIdFlow(final long id) {
    final String _sql = "SELECT * FROM conversations WHERE id = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, id);
